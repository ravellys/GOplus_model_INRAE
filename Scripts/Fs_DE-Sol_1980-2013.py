...
def model(
   ...
   # Set the site specific parameters from csv external file
    paraSiteFilePath =os.path.join(basePath, 'Parameters_files', 'Site', 'DE-Sol.csv')
   ...
   # Set the species parameters from csv external file Fsylvatica 
    ...
    _installation.initialTreesDimensionsFile =os.path.join(basePath, 'Parameters_files', 'Tree_stand', 'DE-Sol_dbh_1980.csv') 
...
#instantiate the model for a specific experiment. Here a test on the hisotrical Time series of FR-HEs site
    ...
    mdl = model( 
        startYear = 1980,
        meteoFile = os.path.join(basePath, 'Met_files', 'Met_DE-Sol_1980-2012.csv'),
        )
    endYear = 2013 #included
    fileoutName =os.path.join(basePath, 'Output_files', 'DE-Sol_1980-2012_dtest.csv')
