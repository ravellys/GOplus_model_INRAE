...
def model(
   ...
   #instanciate the model, set a specific manager and define start year
    ...
    mdl.manager.practicesType   = 2 #Select the management plan to be applied. 0 = standard; 2 = self thinning rule. 
   ...
   ## Set the site specific parameters from csv external file
    paraSiteFilePath            = basePath +'/Parameters files/Site/FR-Mtr_140.csv'
   ...
   ## intialise the tree stand.  
    ...
    _installation.initialTreesDimensionsFile = basePath + '/Parameters files/Tree stand/FR-Mtr_dbh_140_85.csv' 
...
if __name__ == '__main__':
    ...
    mdl = model( 
        startYear = 2006,
        meteoFile = basePath +'/Met files/Met_FR-Mtr_RCP85_2006-2100.csv',
        )
    endYear = 2100
...
#Do simulation
    if endYear>2006:
        ...
        simulate(
            mdl = mdl, 
            endYear = endYear, 
            fileoutName =basePath +'/output files/FR-Mtr_RCP85_age140_2006-2100_unmanaged_y.csv', #  
